...
DEFINE( 'ASSET_VERSION', filemtime( get_template_directory() . '/assets/css/bundle.css' ) + filemtime( get_template_directory() . '/assets/js/bundle.js' ) );
...
function assets() {
	...
	wp_register_script( 'theme-scripts', assetDir . '/js/bundle.js?v=' . ASSET_VERSION, array( 'jquery' ), null, false );
